/*
 * RinOS libc - linux/unistd.h
 * Linux-specific syscall numbers and unistd definitions
 */
...
/* Support __i386__, __i686__, or 32-bit mode (-m32) */
#if defined(__i386__) || defined(__i686__) || (defined(__SIZEOF_POINTER__) && __SIZEOF_POINTER__ == 4)
...
/* RinOS ABI reconciliation:
 * Third-party code may include linux/unistd.h directly and use __NR_* values.
 * Force critical threading/synchronization/signal syscalls to Rin kernel IDs. */
#undef __NR_clone
...
#define __NR_set_tid_address 351

/* syscall function is defined in sys/syscall.h */
